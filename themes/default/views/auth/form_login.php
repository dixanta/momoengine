<?php print form_open('auth/login',array('class'=>'horizontal'))?>
    <fieldset>
        <ol>
            ...
            <li style="margin-left:108px; " >
               
                <?php print form_checkbox('remember','yes',$this->input->post('remember'))?> <label style="line-height:20px;width:auto!important; " for="remember"><?php print $this->lang->line('userlib_remember_me')?>?</label>
            </li>
            <?php
            ...
            <li class="submit">
            	<div class="buttons">
            		...
            		<?php /*?><a href="<?php print site_url('auth/register') ?>">
