...
//tags-input
$config['asset'][] = array('file'=>'tagsinput/jquery.tagsinput.js', 'needs'=>'jquery','name'=>'tagsinput_js','position'=>'header');
$config['asset'][] = array('file'=>'tagsinput/jquery.tagsinput.css','name'=>'tagsinput_css');
...
$config['asset_group']['TAGS_INPUT'] = "tagsinput_js|tagsinput_css";
